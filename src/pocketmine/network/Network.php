...
class Network {
	 ...
	 * @param DataPacket $class
	 */
	public function registerPacketOld($id, $class) {
		$this->packetPool[$id] = new $class;
	}
	...
	private function registerPackets(){
		...
		$this->registerPacketOld(Info::ADD_ENTITY_PACKET, \pocketmine\network\protocol\AddEntityPacket::class);
		$this->registerPacketOld(Info::ADD_HANGING_ENTITY_PACKET, \pocketmine\network\protocol\AddHangingEntityPacket::class);
		$this->registerPacketOld(Info::ADD_ITEM_ENTITY_PACKET, \pocketmine\network\protocol\AddItemEntityPacket::class);
		$this->registerPacketOld(Info::ADD_ITEM_PACKET, \pocketmine\network\protocol\AddItemEntityPacket::class);
		$this->registerPacketOld(Info::ADD_PAINTING_PACKET, \pocketmine\network\protocol\AddPaintingPacket::class);
		$this->registerPacketOld(Info::ADD_PLAYER_PACKET, \pocketmine\network\protocol\AddPlayerPacket::class);
		$this->registerPacketOld(Info::ADVENTURE_SETTINGS_PACKET, \pocketmine\network\protocol\AdventureSettingsPacket::class);
	}
}
